...
namespace BusinessLayer.ValidationRules
{
    public class CommentValidator:AbstractValidator<Comment>
    {
        public CommentValidator()
        {
            ...
            RuleFor(x => x.CommentText).NotEmpty().WithMessage("Lütfen bir yorum yazınız").MinimumLength(8).WithMessage("Yorumunuz en az 8 karekter olması gerekmektedir.").MaximumLength(500).WithMessage("Yorum 500 karakterden fazla olamaz.");
