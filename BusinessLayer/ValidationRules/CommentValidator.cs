...
namespace BusinessLayer.ValidationRules
{
    public class CommentValidator:AbstractValidator<Comment>
    {
        public CommentValidator()
        {
            ...
            RuleFor(x => x.CommentText).NotEmpty().WithMessage("Lütfen bir yorum yazınız").MinimumLength(8).WithMessage("Yorumunuz en az 8 karekter olması gerekmektedir.").MaximumLength(1000).WithMessage("Yorum 1000 karakterden fazla olamaz.");
